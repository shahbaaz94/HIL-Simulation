...
void pid_traction(double t, double dt, double y, double r, double &u);
void pid_speed(double t, double dt, double y, double r, double &u);
void pid_brake(double t, double dt, double y, double r, double &u);
void pid_launch(double t, double dt, double y, double r, double &u);
...
int main()
{
	...
	while(t < tf) {
		...
		if (y[2] < 795) pid_traction(t, dt, slipratio, 0.2, u[1]); // launch control and traction control
		else pid_speed (t, dt, a1+a2, 0, u[1]); // speed control

		if (t > 20) pid_brake(t, dt, a1 + a2, -180, u[1]);

		//if (t > 20)
		//{
		//	if(slipratio < 0.2) pid_brake(t, dt, a1 + a2, -180, u[1]);
		//	else pid_traction(t, dt, slipratio, 0.2, u[1]);
		//}

		//if (t > 20) pid_brake(t, dt, slipratio, -0.2, u[1]);
